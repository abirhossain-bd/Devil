...
<body>
    <div class="app app-auth-sign-up align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <div class="auth-credentials m-b-xxl">
                ...
                <input type="email" class="form-control m-b-md <?php echo (isset($_SESSION['email_error'])) ? 'is-invalid':'' ?> " placeholder="example@neptune.com" name="email" value=" <?= (isset($_SESSION['old_email'])) ? $_SESSION['old_email'] : ''; unset($_SESSION['old_email']); ?> ">
                <?php if(isset($_SESSION['email_error'])) { ?>
                <div id="emailHelp" class="form-text m-b-md text-danger"><?php echo $_SESSION['email_error'] ?></div>
                <?php } unset($_SESSION['email_error']) ?>

                <label for="signUpPassword" class="form-label">Password</label>
                <input id="abir" type="password" class="form-control <?php echo (isset($_SESSION['password_error'])) ? 'is-invalid':'' ?> " placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" name="password" value="<?= (isset($_SESSION['old_password'])) ? $_SESSION['old_password'] : ''; unset($_SESSION['old_password']); ?>">
                <div class="my-2">
                ...
                <input type="password" class="form-control <?php echo (isset($_SESSION['cpassword_error'])) ? 'is-invalid':'' ?>" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" name="c_password" value="<?= (isset($_SESSION['old_cpassword'])) ? $_SESSION['old_cpassword'] : ''; unset($_SESSION['old_cpassword']); ?>">
            ...
            <div class="auth-submit">
                <button type="submit" name="subBtn" href="#" class="btn btn-primary">Sign Up</button>
            </div>
            </form>
    ...
    <script>
        function myFun() {
            var x = document.getElementById('abir')
            if(x.type = "password"){
                x.type = "text"
            }else {
                x.type = "password"
