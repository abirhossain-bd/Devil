...
$post_query = "SELECT * FROM posts WHERE status='active'";
$post = mysqli_query($dbm,$post_query);
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="../../../public2/uploads/portfolio/<?= $portfolio['image'] ?>" alt="img">
                                </div>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="post-avatar-img">
                                                ...
                                                <img style="height: 130px; width:130px" src="../../../public2/uploads/profile/<?= $user['image'] ?>" alt="img">
                                                <?php else: ?>
                                                <img style="height: 130px; width:130px" src="../../../public2/uploads/default/<?= $user['image'] ?>" alt="img">
                                                <?php endif; ?>
                                            </div>
                                           
                                            <div class="post-avatar-content">
                                                <h5><?= (isset($user['name'])) ? $user['name'] : 'Name'; ?></h5>
                                                <p><?= (isset($user['id'])) ? $user['bio'] : '';  ?></p>
                                                <div class="post-avatar-social mt-15">
                                                    <?php foreach($post as $post) : ?>
                                                    <a target="_blank" href="<?= $post['link'] ?>"><i class="<?= $post['icon'] ?>"></i></a>
                                                    <?php endforeach; ?>
